...
{
    /// <summary>
    /// Dedicated adapter for Ollama's local runtime path.
    /// This keeps Ollama explicitly routed through the adapter architecture
    /// instead of hiding it behind the generic legacy fallback.
    /// </summary>
