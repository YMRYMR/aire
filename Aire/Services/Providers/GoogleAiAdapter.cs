...
{
    /// <summary>
    /// Dedicated adapter for Google AI / Gemini runtime behavior.
    /// The request and execution path still uses Aire's shared semantics, but
    /// adapter registration is now explicit instead of falling through the
    /// generic legacy adapter.
    /// </summary>
    public sealed class GoogleAiAdapter : IProviderAdapter
    {
